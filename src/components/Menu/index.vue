        ...
        <template v-for="menu in menuList">
          ...
          >
            ...
            <div v-for="(item,index) in menu.children" :key="index">
              <el-menu-item :to="item.path" :index="item.path">
          ...
          <el-menu-item v-else :key="menu.id" :index="menu.path">
            ...
            <el-menu-item index="4"><a href="https://element.eleme.cn/2.13/#/zh-CN/component/installation" target="_blank">ele官网</a></el-menu-item>
        </el-menu>
    </div>
</template>
<script>
